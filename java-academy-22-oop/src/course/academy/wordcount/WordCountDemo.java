...
public class WordCountDemo {
    ...
    public static final String SAMPLE_TEXT = "Java is a high-level, class-based, object-oriented programming language that is designed to have as few implementation dependencies as possible." +
            ...
            "As of October 2021, Java 17 is the latest version. Java 8, 11 and 17 are the current long-term support (LTS) versions." +
    ...
    public static WordCount[] indexText(String text, int maxCount) {
        ...
        for (String word : words) {
            ...
            if (word.length() < 3 || Arrays.binarySearch(STOP_WORDS, word) >= 0) {
                continue;
            }
    ...
    /**
     * Insert element into array in given index and returns new array size
     *
